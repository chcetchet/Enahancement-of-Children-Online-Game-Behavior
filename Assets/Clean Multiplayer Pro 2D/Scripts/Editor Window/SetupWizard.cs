...
namespace AvocadoShark
{
    ...
    public class SetupWizard : EditorWindow
    {
        ...
        private string AssetPath2D= "Assets/SunnyLand Artwork";
        ...
        [MenuItem("Tools/CMP2D/Setup Wizard")]
        ...
        void OnGUI()
        {
            ...
            GUILayout.Label("Welcome to Clean Multiplayer Pro 2D!", Title);
            GUILayout.Label(
            ...
            GUILayout.Label(
                ...
                SubTitle);
            if (GUILayout.Button("Click here to see all tutorials related to Setting Up and Modifying CMP2D", EditorStyles.linkLabel))
            {
                Application.OpenURL("https://www.youtube.com/playlist?list=PLckFh_MeVz9iJdh7JLmNidxMVFhAFDXVC");
            }
            ...
            if (request.IsCompleted)
            {
                if (request.Status == StatusCode.Success)
                {
                    ...
                    GUI.enabled = !Directory.Exists(AssetPath2D); 
                    if (GUILayout.Button("Install free 2D platform Game Assets pack"))
                    {
                        Application.OpenURL("https://assetstore.unity.com/packages/2d/characters/sunny-land-103349");
                    }

                    GUI.enabled = true; // Enable the GUI for subsequent controls
                    if (Directory.Exists(AssetPath2D))
                    {
                        GUILayout.Label("Installed ✔️", checkStyle);
                    }
